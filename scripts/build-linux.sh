...
OBJS=()
for f in AtelierFonts AtelierArtwork AtelierControls AtelierPalette ColorPicker DrawingTools FileManager LayerHistory LayerStack UiChrome AppState EventBus UiFramework UiChromeLayout UiChromeRender CaptionBar AppSelection AppDocument SimpleDrawingApp; do
  echo "  cc $f.cpp"
