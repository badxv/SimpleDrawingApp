...
OBJS=()
for f in AtelierFonts AtelierArtwork AtelierControls AtelierPalette ColorPicker DrawingTools FileManager LayerHistory LayerStack UiChrome AppState EventBus UiFramework UiChromeLayout UiChromeRender UiControls UiPaletteFloat UiShapeFlyout UiToolbar CaptionBar AppSelection AppDocument SimpleDrawingApp; do
  echo "  cc $f.cpp"
